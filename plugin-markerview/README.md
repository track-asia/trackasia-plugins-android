...
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-markerview-v9:0.4.0'
}
```
...
// In the app build.gradle file
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-markerview-v9:0.5.0-SNAPSHOT'
}
```

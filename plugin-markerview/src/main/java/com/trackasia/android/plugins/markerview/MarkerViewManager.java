package com.trackasia.android.plugins.markerview;
...
public class MarkerViewManager implements MapView.OnCameraDidChangeListener, MapView.OnCameraIsChangingListener {
     ...
     * @param trackasiaMap the MapboxMap to synchronise views with
     */
    public MarkerViewManager(MapView mapView, TrackAsiaMap trackasiaMap) {
    ...
    public void addMarker(@NonNull MarkerView markerView) {
        ...
        markerView.setProjection(trackasiaMap.getProjection());

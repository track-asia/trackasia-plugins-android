package org.trackasia.android.plugins.offline.model;
...
public abstract class NotificationOptions implements Parcelable {
    ...
    public static Builder builder(Context context) {
        return new $AutoValue_NotificationOptions.Builder()
            ...
            .contentTitle(context.getString(R.string.trackasia_offline_notification_default_content_title))
            .contentText(context.getString(R.string.trackasia_offline_notification_default_content_text))
            .cancelText(context.getString(R.string.trackasia_offline_notification_action_cancel))

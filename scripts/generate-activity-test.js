...
const appBasePath = 'app/src/main/java/org/track-asia/android/plugins/testapp/activity';
const testBasePath = 'app/src/androidTest/java/org/track-asia/android/plugins/gen';
const subPackages = fs.readdirSync(appBasePath);
const ejsConversionTask = ejs.compile(fs.readFileSync('app/src/androidTest/java/org/track-asia/android/plugins/activity.junit.ejs', 'utf8'), {strict: true});

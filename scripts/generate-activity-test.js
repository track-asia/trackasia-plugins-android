...
const appBasePath = 'app/src/main/java/com/trackasia/android/plugins/testapp/activity';
const testBasePath = 'app/src/androidTest/java/com/trackasia/android/plugins/gen';
const subPackages = fs.readdirSync(appBasePath);
const ejsConversionTask = ejs.compile(fs.readFileSync('app/src/androidTest/java/com/trackasia/android/plugins/activity.junit.ejs', 'utf8'), {strict: true});

...
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-annotation-v9:0.9.0'
}
```
...
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-annotation-v9:0.10.0-SNAPSHOT'
}
```

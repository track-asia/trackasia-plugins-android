...
for (const layer of layers) {
  if(layer.type === "symbol" || layer.type === "circle" || layer.type === "fill" || layer.type === "line"){
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/On${camelize(layer.type)}DragListener.java`, annotationDragListener(layer));
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/On${camelize(layer.type)}ClickListener.java`, annotationClickListener(layer));
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/On${camelize(layer.type)}LongClickListener.java`, annotationLongClickListener(layer));
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}.java`, annotationJava(layer));
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}Options.java`, annotationOptionsJava(layer));
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}Manager.java`, annotationManagerJava(layer));
      writeIfModified(`plugin-annotation/src/main/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}ElementProvider.java`, annotationElementProvider(layer));
      writeIfModified(`app/src/androidTest/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}Test.java`, annotationJavaInstrumentationTests(layer));
      writeIfModified(`app/src/androidTest/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}ManagerTest.java`, annotationManagerJavaInstrumentationTests(layer));
      writeIfModified(`plugin-annotation/src/test/java/org/track-asia/android/plugins/annotation/${camelize(layer.type)}ManagerTest.java`, annotationManagerJavaUnitTests(layer));
  }
}
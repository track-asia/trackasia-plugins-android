...
import static org.trackasia.android.plugins.annotation.ConvertUtils.convertArray;
...
public class SymbolManagerTest {
    ...
    private TrackAsiaMap trackasiaMap = mock(TrackAsiaMap.class);
    ...
    public void testInitialization() {
        symbolManager = new SymbolManager(mapView, trackasiaMap, style, coreElementProvider, null, null, null, draggableAnnotationController);
    ...
    public void testInitializationOnStyleReload() {
        ...
        verify(trackasiaMap).getStyle(styleLoadedArgumentCaptor.capture());
    ...
    public void testLayerBelowInitialization() {
        symbolManager = new SymbolManager(mapView, trackasiaMap, style, coreElementProvider, "test_layer", null, null, draggableAnnotationController);
        verify(style).addSource(geoJsonSource);
    ...
    public void testGeoJsonOptionsInitialization() {
        symbolManager = new SymbolManager(mapView, trackasiaMap, style, coreElementProvider, null, null, geoJsonOptions, draggableAnnotationController);

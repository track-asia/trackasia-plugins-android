...
public class LineManagerTest {
    ...
    public void testInitialization() {
        lineManager = new LineManager(mapView, trackasiaMap, style, coreElementProvider, null, null, null, draggableAnnotationController);
    ...
    public void testLayerBelowInitialization() {
        lineManager = new LineManager(mapView, trackasiaMap, style, coreElementProvider, "test_layer", null, null, draggableAnnotationController);
        verify(style).addSource(geoJsonSource);
    ...
    public void testGeoJsonOptionsInitialization() {
        lineManager = new LineManager(mapView, trackasiaMap, style, coreElementProvider, null, null, geoJsonOptions, draggableAnnotationController);

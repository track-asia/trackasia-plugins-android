...
public class CircleManagerTest {
    ...
    public void testInitialization() {
        circleManager = new CircleManager(mapView, trackasiaMap, style, coreElementProvider, null, null, null, draggableAnnotationController);
    ...
    public void testLayerBelowInitialization() {
        circleManager = new CircleManager(mapView, trackasiaMap, style, coreElementProvider, "test_layer", null, null, draggableAnnotationController);
        verify(style).addSource(geoJsonSource);
    ...
    public void testGeoJsonOptionsInitialization() {
        circleManager = new CircleManager(mapView, trackasiaMap, style, coreElementProvider, null, null, geoJsonOptions, draggableAnnotationController);

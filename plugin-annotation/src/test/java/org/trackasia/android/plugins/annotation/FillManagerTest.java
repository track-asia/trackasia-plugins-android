...
public class FillManagerTest {
    ...
    public void testInitialization() {
        fillManager = new FillManager(mapView, trackasiaMap, style, coreElementProvider, null, null, null, draggableAnnotationController);
    ...
    public void testLayerBelowInitialization() {
        fillManager = new FillManager(mapView, trackasiaMap, style, coreElementProvider, "test_layer", null, null, draggableAnnotationController);
        verify(style).addSource(geoJsonSource);
    ...
    public void testGeoJsonOptionsInitialization() {
        fillManager = new FillManager(mapView, trackasiaMap, style, coreElementProvider, null, null, geoJsonOptions, draggableAnnotationController);

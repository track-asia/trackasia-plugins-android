...
public class DraggableAnnotationControllerTest {
    ...
    public void before() {
        ...
        draggableAnnotationController = new DraggableAnnotationController(mapView, trackasiaMap, androidGesturesManager,
    ...
    public void gestureOnMoveMoveNoGeometryTest() {
        ...
        when(trackasiaMap.getProjection()).thenReturn(projection);

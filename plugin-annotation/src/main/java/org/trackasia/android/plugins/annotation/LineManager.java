...
public class LineManager extends AnnotationManager<LineLayer, Line, LineOptions, OnLineDragListener, OnLineClickListener, OnLineLongClickListener> {
     ...
     *
     * @param trackasiaMap the map object to add lines to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, trackasiaMap, style, new LineElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, trackasiaMap));
    }

    @UiThread
    LineManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @NonNull CoreElementProvider<LineLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

...
public class CircleManager extends AnnotationManager<CircleLayer, Circle, CircleOptions, OnCircleDragListener, OnCircleClickListener, OnCircleLongClickListener> {
     ...
     *
     * @param trackasiaMap the map object to add circles to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, trackasiaMap, style, new CircleElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, trackasiaMap));
    }

    @UiThread
    CircleManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @NonNull CoreElementProvider<CircleLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

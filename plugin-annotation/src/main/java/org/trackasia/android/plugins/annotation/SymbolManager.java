...
import static org.trackasia.android.style.expressions.Expression.get;
...
public class SymbolManager extends AnnotationManager<SymbolLayer, Symbol, SymbolOptions, OnSymbolDragListener, OnSymbolClickListener, OnSymbolLongClickListener> {
     ...
     *
     * @param trackasiaMap the map object to add symbols to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style) {
        this(mapView, trackasiaMap, style, null, null, (GeoJsonOptions) null);
    }
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
        this(mapView, trackasiaMap, style, belowLayerId, aboveLayerId, (GeoJsonOptions) null);
    }
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, trackasiaMap, style, new SymbolElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, trackasiaMap));
    }
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @NonNull ClusterOptions clusterOptions) {
        this(mapView, trackasiaMap, style, new SymbolElementProvider(), belowLayerId, aboveLayerId, new GeoJsonOptions().withCluster(true).withClusterRadius(clusterOptions.getClusterRadius()).withClusterMaxZoom(clusterOptions.getClusterMaxZoom()), DraggableAnnotationController.getInstance(mapView, trackasiaMap));
        clusterOptions.apply(style, coreElementProvider.getSourceId());
    }

    @UiThread
    SymbolManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @NonNull CoreElementProvider<SymbolLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {
        super(mapView, trackasiaMap, style, coreElementProvider, draggableAnnotationController, belowLayerId, aboveLayerId, geoJsonOptions);
    }

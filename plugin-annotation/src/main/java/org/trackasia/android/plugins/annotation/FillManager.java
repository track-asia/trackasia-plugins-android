...
public class FillManager extends AnnotationManager<FillLayer, Fill, FillOptions, OnFillDragListener, OnFillClickListener, OnFillLongClickListener> {
     ...
     *
     * @param trackasiaMap the map object to add fills to
     * @param style     a valid a fully loaded style object
     */
    @UiThread
    public FillManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public FillManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId) {
     ...
     */
    @UiThread
    public FillManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
        this(mapView, trackasiaMap, style, new FillElementProvider(), belowLayerId, aboveLayerId, geoJsonOptions, DraggableAnnotationController.getInstance(mapView, trackasiaMap));
    }

    @UiThread
    FillManager(@NonNull MapView mapView, @NonNull TrackAsiaMap trackasiaMap, @NonNull Style style, @NonNull CoreElementProvider<FillLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable String aboveLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

...
public class FillManager extends AnnotationManager<FillLayer, Fill, FillOptions, OnFillDragListener, OnFillClickListener, OnFillLongClickListener> {
     ...
     */
    @UiThread
    public FillManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public FillManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId) {
     ...
     */
    @UiThread
    public FillManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
    ...
    @VisibleForTesting
    FillManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @NonNull CoreElementProvider<FillLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

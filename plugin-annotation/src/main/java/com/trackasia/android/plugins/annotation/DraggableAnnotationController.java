...
final class DraggableAnnotationController {
    ...
    public static DraggableAnnotationController getInstance(MapView mapView, TrackasiaMap mapboxMap) {
    ...
    DraggableAnnotationController(MapView mapView, TrackasiaMap mapboxMap) {
    ...
    @VisibleForTesting
    public DraggableAnnotationController(MapView mapView, TrackasiaMap mapboxMap,

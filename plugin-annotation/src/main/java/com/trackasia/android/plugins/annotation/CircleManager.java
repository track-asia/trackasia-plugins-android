...
public class CircleManager extends AnnotationManager<CircleLayer, Circle, CircleOptions, OnCircleDragListener, OnCircleClickListener, OnCircleLongClickListener> {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId) {
     ...
     */
    @UiThread
    public CircleManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
    ...
    @VisibleForTesting
    CircleManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @NonNull CoreElementProvider<CircleLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

...
public class LineManager extends AnnotationManager<LineLayer, Line, LineOptions, OnLineDragListener, OnLineClickListener, OnLineLongClickListener> {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId) {
     ...
     */
    @UiThread
    public LineManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
    ...
    @VisibleForTesting
    LineManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @NonNull CoreElementProvider<LineLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

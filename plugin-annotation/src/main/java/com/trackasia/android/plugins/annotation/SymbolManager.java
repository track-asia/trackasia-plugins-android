...
public class SymbolManager extends AnnotationManager<SymbolLayer, Symbol, SymbolOptions, OnSymbolDragListener, OnSymbolClickListener, OnSymbolLongClickListener> {
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style) {
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId) {
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions) {
     ...
     */
    @UiThread
    public SymbolManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @Nullable String belowLayerId, @NonNull ClusterOptions clusterOptions) {
    ...
    @VisibleForTesting
    SymbolManager(@NonNull MapView mapView, @NonNull TrackasiaMap mapboxMap, @NonNull Style style, @NonNull CoreElementProvider<SymbolLayer> coreElementProvider, @Nullable String belowLayerId, @Nullable GeoJsonOptions geoJsonOptions, DraggableAnnotationController draggableAnnotationController) {

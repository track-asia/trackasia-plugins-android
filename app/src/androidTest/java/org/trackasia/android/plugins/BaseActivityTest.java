package org.trackasia.android.plugins;
...
import org.trackasia.android.plugins.annotation.WaitAction;
import org.trackasia.android.plugins.utils.OnMapReadyIdlingResource;
...
public abstract class BaseActivityTest {
    ...
    public void beforeTest() {
        try {
            ...
            Espresso.onIdle();
            trackasiaMap = idlingResource.getTrackAsiaMap();
    ...
    protected void validateTestSetup() {
        ...
        Assert.assertNotNull(trackasiaMap);
    }
    ...
    protected TrackAsiaMapAction getMapboxMapAction(TrackAsiaMapAction.OnInvokeActionListener onInvokeActionListener) {
        return new TrackAsiaMapAction(onInvokeActionListener, trackasiaMap);
    }

package org.trackasia.android.plugins.scalebar;
...
import org.trackasia.android.plugins.annotation.TrackAsiaMapAction;
...
public class ScaleBarTest extends BaseActivityTest {
    ...
    private void setupScaleBar() {
        ...
        TrackAsiaMapAction.invoke(trackasiaMap, (uiController, trackasiaMap) -> {
            scaleBarPlugin = new ScaleBarPlugin(idlingResource.getMapView(), trackasiaMap);
    ...
    public void testTextBorder() {
        ...
        setupScaleBar();
        TrackAsiaMapAction.invoke(trackasiaMap, (uiController, trackasiaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.trackasia_scale_bar_text_border_width),
    ...
    public void testMargin() {
        ...
        setupScaleBar();
        TrackAsiaMapAction.invoke(trackasiaMap, (uiController, trackasiaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.trackasia_scale_bar_margin_left),
                scaleBarWidget.getMarginLeft(), 0);
            assertEquals(activity.getResources().getDimension(R.dimen.trackasia_scale_bar_margin_top),
                scaleBarWidget.getMarginTop(), 0);
            assertEquals(activity.getResources().getDimension(R.dimen.trackasia_scale_bar_text_margin),
    ...
    public void testBarHeight() {
        ...
        setupScaleBar();
        TrackAsiaMapAction.invoke(trackasiaMap, (uiController, trackasiaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.trackasia_scale_bar_height),
    ...
    public void testBorderWidth() {
        ...
        setupScaleBar();
        TrackAsiaMapAction.invoke(trackasiaMap, (uiController, trackasiaMap) -> {
            assertEquals(activity.getResources().getDimension(R.dimen.trackasia_scale_bar_border_width),

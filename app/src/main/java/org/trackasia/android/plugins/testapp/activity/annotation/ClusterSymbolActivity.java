...
import org.trackasia.android.plugins.annotation.ClusterOptions;
...
public class ClusterSymbolActivity extends AppCompatActivity {
    ...
    private void initMap(TrackAsiaMap trackasiaMap) {
        ...
        trackasiaMap.setStyle(new Style.Builder().fromUri(Style.getPredefinedStyle("Streets")), style -> {
            symbolManager = new SymbolManager(mapView, trackasiaMap, style, null, null, clusterOptions);

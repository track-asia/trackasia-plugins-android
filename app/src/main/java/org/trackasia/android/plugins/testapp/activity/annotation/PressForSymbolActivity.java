...
import static org.trackasia.android.style.layers.Property.ICON_ANCHOR_BOTTOM;
...
public class PressForSymbolActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(map -> {
            ...
            trackasiaMap.setStyle(getStyleBuilder(Style.getPredefinedStyle("Streets")), style -> {

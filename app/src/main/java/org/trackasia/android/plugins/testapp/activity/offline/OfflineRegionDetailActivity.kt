package org.trackasia.android.plugins.testapp.activity.offline
...
import org.trackasia.android.plugins.offline.offline.OfflineConstants.KEY_BUNDLE
import org.trackasia.android.plugins.offline.offline.OfflineDownloadChangeListener
import org.trackasia.android.plugins.offline.offline.OfflinePlugin
import org.trackasia.android.plugins.offline.utils.OfflineUtils
import org.trackasia.android.plugins.testapp.R
import org.trackasia.android.plugins.testapp.databinding.ActivityOfflineRegionDetailBinding
...
class OfflineRegionDetailActivity : AppCompatActivity(),
    ...
    private fun setupUI(definition: OfflineRegionDefinition) {
        ...
        mapView?.getMapAsync { trackasiaMap ->
            // correct style
            trackasiaMap.setOfflineRegionDefinition(definition) { _ ->
                // restrict camera movement
                trackasiaMap.setLatLngBoundsForCameraTarget(definition.bounds)
    ...
    companion object {
        ...
        val KEY_REGION_ID_BUNDLE = "org.trackasia.android.plugins.offline.bundle.id"
    }
}

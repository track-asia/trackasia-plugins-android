...
import org.trackasia.android.plugins.annotation.Fill;
import org.trackasia.android.plugins.annotation.FillManager;
import org.trackasia.android.plugins.annotation.FillOptions;
...
public class FillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(trackasiaMap -> trackasiaMap.setStyle(Style.getPredefinedStyle("Streets"), style -> {
            ...
            fillManager = new FillManager(mapView, trackasiaMap, style);

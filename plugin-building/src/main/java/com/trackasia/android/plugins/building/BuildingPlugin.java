 ...
 * Android v5.1.0.
 * <p>
 * Initialise this plugin in the {@link com.trackasia.android.maps.OnMapReadyCallback#onMapReady(MapboxMap)}
...
public final class BuildingPlugin {
   ...
   * @param mapboxMap the TrackasiaMap to apply building plugin with
   * @since 0.1.0
   */
  public BuildingPlugin(@NonNull MapView mapView, @NonNull final TrackasiaMap mapboxMap, @NonNull Style style) {

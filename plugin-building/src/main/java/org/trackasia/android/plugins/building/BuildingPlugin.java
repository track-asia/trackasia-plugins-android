package org.trackasia.android.plugins.building;
...
import static org.trackasia.android.constants.TrackAsiaConstants.MAXIMUM_ZOOM;
import static org.trackasia.android.constants.TrackAsiaConstants.MINIMUM_ZOOM;
import static org.trackasia.android.style.expressions.Expression.exponential;
...
import static org.trackasia.android.style.expressions.Expression.literal;
...
import static org.trackasia.android.style.layers.PropertyFactory.visibility;

/**
 * The building plugin allows you to add 3d buildings FillExtrusionLayer to the Mapbox Maps SDK for
 * Android v5.1.0.
 * <p>
 * Initialise this plugin in the {@link org.trackasia.android.maps.OnMapReadyCallback#onMapReady(TrackAsiaMap)}
 * and provide a valid instance of {@link MapView} and {@link TrackAsiaMap}.
 * </p>
 * <ul>
...
public final class BuildingPlugin {
     ...
     * @param TrackAsiaMap the TrackAsiaMap to apply building plugin with
     * @since 0.1.0
     */
    public BuildingPlugin(@NonNull MapView mapView, @NonNull final TrackAsiaMap TrackAsiaMap, @NonNull Style style) {
        this(mapView, TrackAsiaMap, style, null);
    }
    ...
    public BuildingPlugin(@NonNull MapView mapView, @NonNull final TrackAsiaMap TrackAsiaMap, @NonNull Style style,
        ...
        mapView.addOnDidFinishLoadingStyleListener(new MapView.OnDidFinishLoadingStyleListener() {
            ...
            public void onDidFinishLoadingStyle() {
                TrackAsiaMap.getStyle(new Style.OnStyleLoaded() {
                    @Override

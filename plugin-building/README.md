...
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-building-v9:0.7.0'
}
```
...
// In the app build.gradle file
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-building-v9:0.8.0-SNAPSHOT'
}
```

...
public class ScaleBarOptions {
    ...
    public ScaleBarOptions(@NonNull Context context) {
        ...
        setBarHeight(R.dimen.trackasia_scale_bar_height);
        setBorderWidth(R.dimen.trackasia_scale_bar_border_width);
        setTextSize(R.dimen.trackasia_scale_bar_text_size);
        setMarginTop(R.dimen.trackasia_scale_bar_margin_top);
        setMarginLeft(R.dimen.trackasia_scale_bar_margin_left);
        setTextBarMargin(R.dimen.trackasia_scale_bar_text_margin);
        setTextBorderWidth(R.dimen.trackasia_scale_bar_text_border_width);

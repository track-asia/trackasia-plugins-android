...
public class ScaleBarPlugin {
     ...
     * <p>
     * If the scale plugin wasn enabled, a {@link org.trackasia.android.maps.TrackAsiaMap.OnCameraMoveListener}
     * will be added to the {@link MapView} to listen to scale change events to update the state of this plugin. If the
     * plugin was disabled the {@link org.trackasia.android.maps.TrackAsiaMap.OnCameraMoveListener}

...
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-scalebar-v9:0.5.0'
}
```
...
// In the app build.gradle file
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-scalebar-v9:0.6.0-SNAPSHOT'
}
```

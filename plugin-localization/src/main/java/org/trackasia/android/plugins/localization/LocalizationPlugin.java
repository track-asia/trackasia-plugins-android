...
import static org.trackasia.android.style.expressions.Expression.raw;
import static org.trackasia.android.style.layers.PropertyFactory.textField;
...
public final class LocalizationPlugin {
     ...
     * @param trackasiaMap the Mapbox map object which your current map view is using for control
     * @param style     the Style object that represents a fully loaded style
     */
    public LocalizationPlugin(@NonNull MapView mapView, @NonNull final TrackAsiaMap trackasiaMap, @NonNull Style style) {
    ...
    public void setCameraToLocaleCountry(MapLocale mapLocale, int padding) {
        ...
        trackasiaMap.moveCamera(CameraUpdateFactory.newLatLngBounds(bounds, padding));
    }

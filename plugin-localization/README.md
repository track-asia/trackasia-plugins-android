...
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-localization-v9:0.12.0'
}
```
...
// In the app build.gradle file
dependencies {
    implementation 'com.trackasia.android:mapbox-android-plugin-localization-v9:0.13.0-SNAPSHOT'
}
```
